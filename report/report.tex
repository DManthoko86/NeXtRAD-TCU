...
\end{flushleft}
	...
	\caption{(a) Main bang and digitization signal with the measurement of the main offset shown in the markers box toward the bottom of the image. (b) Same as figure \ref{fig:Ng1} but with the measurement of the digitization offset shown in the  markers box.}
	\end{figure}
